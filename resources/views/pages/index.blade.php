...
@section('content')
    <div class="section-bg-video grunge-border">
        ...
        <div class="container text-center content overlay-content white" data-anima="fade-top" data-timeline="asc" data-time="1000" style="padding-top: 150px; padding-bottom: 150px;">
            ...
            <a href="{{ route('pages.christmas') }}" target="_blank" class="btn btn-border btn-sm anima anima-fade-bottom" style="margin-top: 10px;">Elviteles Karácsonyi Ajánlat</a>
            <a href="{{ route('pages.new-year') }}" target="_blank" class="btn btn-border btn-sm anima anima-fade-bottom" style="margin-top: 10px;">Elviteles Szilveszteri Ajánlat</a>
