    ...
    <div class="container content">
        ...
        <div class="row">
            ...
            {{-- <div class="col-md-6" style=""> --}}
                ...
                {{--         @endforeach --}}
                {{--     </div> --}}
                {{--     @if($weeklyMenu['saturday-menu'] != null)<h3 class="text-center">{{ $weeklyMenu['saturday-menu']['name'] }} <br><small>2300 Ft</small></h3>@endif --}}
                {{-- </div> --}}
            {{-- </div> --}}
            {{-- <div class="col-md-6" style=""> --}}
                {{-- <div class="text-left title-base"> --}}
                ...
                {{--         @endforeach --}}
                {{--     </div> --}}
                {{--     @if($weeklyMenu['sunday-menu'] != null)<h3 class="text-center">{{ $weeklyMenu['sunday-menu']['name'] }} <br><small>2300 Ft</small></h3>@endif --}}
                {{-- </div> --}}
            {{-- </div> --}}
        </div>
